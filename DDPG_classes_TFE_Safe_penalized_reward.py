...
class Environment(py_environment.PyEnvironment):
    ...
    def _step(self, action):
        ...
        #Penalize the reward if the SoC is out of its existing interval [0;1]
        if new_soc <=1 and new_soc >=0:
            penalized = 0
        else:
            penalized = 200
        ...
        reward = float(delta_price) * (-network_charge_MW / 4) - cost - penalized
